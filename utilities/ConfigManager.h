...
public:
    ...
    struct SherpaOnnxConfig {
        ...
        int rule3_min_utterance_length = 300;
    ...
    /**
     * Get Sherpa ONNX speech recognition configuration
     */
    static const SherpaOnnxConfig& getSherpaOnnxConfig();
...
private:
    ...
    static SherpaOnnxConfig sherpa_onnx_config_;
    static bool loaded_;
};
